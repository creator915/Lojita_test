...
| `make verify` | aggregate native/packet/provider/bridge/MAlonzo/differential plus legacy gates | PASS from second clean clone on Goal 2 closing baseline `97a9129`; run `32753401570`. This is technical evidence, not independent Goal 3 acceptance. | macOS 15 Intel clean clone |
